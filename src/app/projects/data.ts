...
export const projectsData: ProjectData[] = [
    {
        ...
        progress: 72,
        color: '#8B6914',
        imageDir: '/projects/reconstruction',
        imageCount: 8,
    },
    {
        slug: 'prescolaire',
    ...
    },
    {
        ...
        progress: 34,
        color: '#3A6B4E',
        imageDir: '/projects/entrepreneuriat',
        imageCount: 8,
    },
];
...
export function getProjectImages(project: ProjectData): string[] {
    return Array.from({ length: project.imageCount }, (_, i) => `${project.imageDir}/${i + 1}.jpg`);
}
